...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrganicPetModel organicPetModel = new OrganicPetModel("Winnie", PetTypeEnums.DOG, "null", "Husky", 2, PetHeathEnums.HEALTHY, PetMoodEnums.EXCITED,
        TempermentEnums.ACTIVE,true, null, null
                );
        organicPetModel.setId(1l);
        organicPetService.saveOrganic(organicPetModel);

        OrganicPetModel organicPetModel2 = new OrganicPetModel("Lou", PetTypeEnums.CAT, "null", "Tiger", 2, PetHeathEnums.HEALTHY, 
        ...
        OrganicPetModel organicPetModel3 = new OrganicPetModel("Joll", PetTypeEnums.DOG, "null", "Wolf", 1, PetHeathEnums.HUNGRY, 
        ...
        RoboticPetModel roboticPetModel3 = new RoboticPetModel("CROWO", PetTypeEnums.ROBOTIC_DOG, "null", "Jona",
                "Google",
